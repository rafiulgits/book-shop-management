...
<?php startblock('content') ?>
				...
				<div class="col-md-3">
					<div class="book-card">
						<div class="card-body">
							...
							<a href="book.php?isbn=<?php echo $bookList[$item]->isbn ?>" class="btn btn-light">Details</a>
						</div>
					</div>
				</div>
			<?php endfor; ?>
	...
	<br><br><br><br>
	<h4 class="display-4 text-center">Filter Books By</h4>
		...
		<div class="row justify-content-center">
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="category.php?name=<?php echo $categoryList[$item]->name ?>" class="list-group-item list-group-item-action"><?php echo $categoryList[$item]->name; ?> 
			...
			<div class="col-md-3">
				<div class="list-group">
					<h4 class="list-group-item">Authors</h4>
					<?php for($item=0; $item<count($authorList); $item++): ?>
					<a href="author.php?name=<?php echo $authorList[$item]->name ?>" class="list-group-item list-group-item-action"><?php echo $authorList[$item]->name; ?> 
			...
			<div class="col-md-3">
				<div class="list-group">
					<h4 class="list-group-item">Publishers</h4>
					<?php for($item=0; $item<count($publisherList); $item++): ?>
					<a href="publisher.php?name=<?php echo $publisherList[$item]->name ?>" class="list-group-item list-group-item-action"><?php echo $publisherList[$item]->name; ?> 
